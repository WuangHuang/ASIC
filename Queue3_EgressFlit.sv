...
module Queue3_EgressFlit(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  input  [3:0]  io_enq_bits_ingress_id,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  wire [1:0]  _ptr_diff_T = enq_ptr_value - deq_ptr_value;	// @[src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Decoupled.scala:309:32]
  ...
  ram_3x75 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_payload, io_enq_bits_tail, io_enq_bits_head})	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_head = empty ? io_enq_bits_head : _ram_ext_R0_data[0];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :261:25, :293:17, :298:17, :299:19]
  assign io_deq_bits_tail = empty ? io_enq_bits_tail : _ram_ext_R0_data[1];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :261:25, :293:17, :298:17, :299:19]
  assign io_deq_bits_payload = empty ? io_enq_bits_payload : _ram_ext_R0_data[74:2];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91, :261:25, :293:17, :298:17, :299:19]
  assign io_count = ptr_match ? {2{maybe_full}} : deq_ptr_value > enq_ptr_value ? _ptr_diff_T - 2'h1 : _ptr_diff_T;	// @[src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Decoupled.scala:243:7, :259:27, :260:33, :309:32, :314:20, :316:10, :317:{10,25,57}]
endmodule
