...
module TilePRCIDomain(	// @[generators/rocket-chip/src/main/scala/prci/ClockDomain.scala:14:9]
  input  [1:0]  auto_element_reset_domain_rockettile_hartid_in,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  input  [2:0]  auto_tl_master_clock_xing_out_b_bits_opcode,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  input  [3:0]  auto_tl_master_clock_xing_out_b_bits_size,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  input  [1:0]  auto_tl_master_clock_xing_out_b_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  input  [7:0]  auto_tl_master_clock_xing_out_b_bits_mask,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  input  [63:0] auto_tl_master_clock_xing_out_b_bits_data,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  input         auto_tl_master_clock_xing_out_b_bits_corrupt,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  input         auto_tl_master_clock_xing_out_e_ready,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  TLBuffer_a32d64s2k2z4c_1 buffer (	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:75:28]
    ...
    .auto_out_b_bits_opcode  (auto_tl_master_clock_xing_out_b_bits_opcode),
    ...
    .auto_out_b_bits_data    (auto_tl_master_clock_xing_out_b_bits_data),
    .auto_out_b_bits_corrupt (auto_tl_master_clock_xing_out_b_bits_corrupt),
