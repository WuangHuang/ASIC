...
module TLFragmenter_ScratchpadBank(	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
  ...
  wire [5:0]  _repeater_io_deq_bits_source;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:274:30]
  ...
  Repeater_TLBundleA_a32d64s6k1z3u repeater (	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:274:30]
    .clock               (clock),
    .reset               (reset),
  ...
  assign auto_anon_in_d_bits_source = auto_anon_out_d_bits_source[9:4];	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :238:47]
  ...
  assign auto_anon_out_a_bits_address = {_repeater_io_deq_bits_address[31:6], _repeater_io_deq_bits_address[5:0] | {~(aFragnum | _aOrigOH1_T[5:3]), 3'h0}};	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :274:30, :305:30, :316:{49,51,88,111}, generators/rocket-chip/src/main/scala/util/package.scala:243:{71,76}]
